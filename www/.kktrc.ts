    ...
    conf.optimization = {
      ...
      splitChunks: {
        ...
        cacheGroups: {
          ...
          ...cacheGroups([
            'pbi','wl','br','gy','mc','bl','vl','ad', 'ae', 'ji', 'tn', 'vv', 'ir', 'bi', 'bs', 'bts', 'ccp', 'cg', 'ci', 'di', 'ei', 'ev', 'fa', 'fc', 'fd', 'fg', 'fi', 'gi', 'go', 'gr', 'hi', 'ic', 'ii', 'ik', 'io', 'lg', 'md', 'mi', 'mp', 'pk', 'ri', 'scwi', 'si', 'sti', 'tb', 'ti', 'uiw', 'vsc', 'wi',
          ]),
        }
      }
    }
